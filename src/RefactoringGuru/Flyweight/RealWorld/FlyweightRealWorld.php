...
class CatVariation
{
     ...
     *
     * RU:
     * Отобразить информацию о кошке. Метод принимает внешнее состояние в качестве
     ...
     * РазновидностиКошек вместо того, чтобы держать её в классе Кошки.
     ...
     * «переработали» идеальное приложение, где все данные изначально находились
...
class Cat
{
     ...
     *
     * RU:
     * Поскольку объекты Контекста не владеют всем своим состоянием, иногда вам 
     * необходимо предоставить некоторый удобный вспомогательный метод (например,
     * для сравнения их данных с другими объектами).
     *
     * @param $query
     * @return bool
     */
     ...
     * которые делегируют исполнение объекту Легковеса. Эти методы могут быть 
 ...
 *
 * RU:
 * Фабрика Легковеса хранит объекты Контекст и Легковес, эффективно скрывая

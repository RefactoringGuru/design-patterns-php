 ...
 * Каждая запись в базе данных представлена объектом Кошка. Его данные состоят из двух частей:
 * 
...
class CatVariation
{
     ...
     * 
     * Имейте в виду, что в реальной жизни паттерн Легковес может быть реализован
     * с самого начала или принудительно установлен в существующее приложение, 
     * как только разработчики понимают, что они столкнулись с проблемой ОЗУ.
     */

 ...
 * Каждая запись в базе данных представлена объектом Кот. Его данные состоят из двух частей:
 * 
 ...
 *
 * Первая часть хранится непосредственно внутри класса Кот, который играет роль контекста.
 * Вторая часть, однако, хранится отдельно и может использоваться несколькими кошками.
 */

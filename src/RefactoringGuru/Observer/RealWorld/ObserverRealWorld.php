 ...
 *
 * RU:
 * ПользовательскийРепозиторий представляет собой Издателя. Различные объекты
...
class UserRepository implements \SplSubject
{
    ...
    // что это не все, за что отвечает наш класс. Его основная бизнес-логика приведена
    // ниже этих методов.

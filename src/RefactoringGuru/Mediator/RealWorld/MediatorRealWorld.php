 ...
 *
 * Достичь такой слабой связанности между компонентами можно благодаря тому,
 * каким способом устанавливаются связи между ними. Компоненты сами могут подписаться
 * на интересующие их конкретные события через интерфейс подписки Посредника.
 *

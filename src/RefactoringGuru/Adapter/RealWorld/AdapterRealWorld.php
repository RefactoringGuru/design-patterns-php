 ...
 * даже если они несовместимы с основной частью кода. Например, для поддержки сторонних служб,
 * таких как Slack, Facebook, SMS и т.д., вместо перезаписи интерфейса уведомлений приложения,
 * создается набор специальных оберток. Обертки адаптируют вызовы из приложения к интерфейсу и формату, 

 ...
 *
 * Назначение: Определите интерфейс для создания объекта, но пусть подклассы
 * решают, какого класса создавать экземпляр. Фабричный Метод позволяет классу
...
abstract class Creator
{
     ...
     *
     * RU:
     * Также заметьте, что, несмотря на имя, 
     ...
     * на объектах Продукты, возвращенных фабричным методом. 

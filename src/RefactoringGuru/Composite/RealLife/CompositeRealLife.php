...
namespace RefactoringGuru\Composite\RealLife;
 ...
 * instance, while the various input elements can act as leafs, the form and
 * fieldsets will play role of composites.
 */

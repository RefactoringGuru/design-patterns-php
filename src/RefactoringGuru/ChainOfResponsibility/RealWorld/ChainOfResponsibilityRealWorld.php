 ...
 * в мире PHP находится в фильтрах обработки HTTP-запроса. Они реализованы 
 * большинством популярных PHP-фреймворков и даже стандартизированы как часть PSR-15.
 *
 * Это работает следующим образом: HTTP-запрос должен пройти через стек объектов 
 * промежуточного программного обеспечения, чтобы быть обработанным приложением.
 * Каждое middleware может либо отклонить дальнейшую обработку запроса, либо передать
